...
export function StatsKPI({ stats }: Props) {
  if (!stats) {
    return (
  ...
  return (
    <div className={styles.grid}>
      <div className={styles.card}>
        <span className={styles.label}>🔥 Серия дней</span>
        <span className={`${styles.value} ${styles.valueStreak}`}>{streakDays}</span>
      </div>

      <div className={styles.card}>
        <span className={styles.label}>📊 Всего решено</span>
        <span className={`${styles.value} ${styles.valueTotal}`}>{solvedTotal}</span>
      </div>

      <div className={styles.card}>
        <span className={styles.label}>⚡ С первой попытки</span>
      ...
      <div className={styles.card}>
        <span className={styles.label}>📅 Дней активности</span>
        <span className={`${styles.value} ${styles.valueDays}`}>{daysWithActivity || '—'}</span>
      </div>

      <div className={styles.card}>
        <span className={styles.label}>🏆 Самый длинный streak</span>
      ...
      <div className={styles.card}>
        <span className={styles.label}>📈 За 7 дней</span>
